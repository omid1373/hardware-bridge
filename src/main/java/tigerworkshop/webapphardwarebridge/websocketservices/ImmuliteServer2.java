...
public class ImmuliteServer2 extends Thread {
    ...
    public ImmuliteServer2(String port, String urlpath, Integer threadNumber, String eqId) {
                    ...
                    try {
                        if (serialPort.isOpen()){
                            ...
                            if (serialPort.bytesAvailable() == 0){
                                ...
                                if((ch[0]!=(char)10) && (ch[0]!=(char)13) && (ch[0]!=(char)3) && (ch[0]!=(char)2)&&
                                        (ch[0]!=(char)4) && (ch[0]!=(char)6) && (ch[0]!=(char)5) && (ch[0]!=(char)21)){
                                    if(messageStr == null)
